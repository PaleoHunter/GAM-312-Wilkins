...
void APlayerChar::UpdateResources(float woodAmount, float stoneAmount, FString buildingObjects)
{
	if (woodAmount <= ResourcesArray[0])
	{
		if (stoneAmount <= ResourcesArray[1])
		{
			...
			if (buildingObjects == "Wall")
			{
				BuildingArray[0] = BuildingArray[0] + 1;
			}

			if (buildingObjects == "Floor")
			{
				BuildingArray[1] = BuildingArray[1] + 1;
			}

			if (buildingObjects == "Ceiling")
			{
